...
uint32_t VL53LX_events_per_spad_maths(
    int32_t VL53LX_p_010, uint16_t num_spads, uint32_t duration)
{
...
void VL53LX_hist_estimate_ambient_from_thresholded_bins(
    int32_t ambient_threshold_sigma, VL53LX_histogram_bin_data_t* pdata)
{
...
void VL53LX_copy_xtalk_bin_data_to_histogram_data_struct(
    VL53LX_xtalk_histogram_shape_t* pxtalk, VL53LX_histogram_bin_data_t* phist)
{
...
void VL53LX_init_histogram_bin_data_struct(
    int32_t bin_value, uint16_t VL53LX_p_021, VL53LX_histogram_bin_data_t* pdata)
{
