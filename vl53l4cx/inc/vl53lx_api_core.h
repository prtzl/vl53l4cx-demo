...
extern "C"
{
    ...
    VL53LX_Error VL53LX_get_version(VL53LX_DEV Dev, VL53LX_ll_version_t* pversion);
    ...
    VL53LX_Error VL53LX_set_part_to_part_data(
        VL53LX_DEV Dev, VL53LX_calibration_data_t* pcal_data);
    ...
    VL53LX_Error VL53LX_get_measurement_results(
        VL53LX_DEV Dev, VL53LX_DeviceResultsLevel device_result_level);
    ...
    VL53LX_Error VL53LX_get_histogram_bin_data(
        VL53LX_DEV Dev, VL53LX_histogram_bin_data_t* phist_data);
    ...
    VL53LX_Error VL53LX_set_offset_correction_mode(
        VL53LX_DEV Dev, VL53LX_OffsetCalibrationMode offset_cor_mode);
