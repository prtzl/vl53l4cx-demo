...
#define VL53LX_DEVICEPRESETMODE_NONE ((VL53LX_DevicePresetModes)0)
#define VL53LX_DEVICEPRESETMODE_HISTOGRAM_LONG_RANGE ((VL53LX_DevicePresetModes)27)
#define VL53LX_DEVICEPRESETMODE_HISTOGRAM_MEDIUM_RANGE ((VL53LX_DevicePresetModes)30)
#define VL53LX_DEVICEPRESETMODE_HISTOGRAM_SHORT_RANGE ((VL53LX_DevicePresetModes)33)

typedef uint8_t VL53LX_DeviceMeasurementModes;

#define VL53LX_DEVICEMEASUREMENTMODE_STOP ((VL53LX_DeviceMeasurementModes)0x00)
#define VL53LX_DEVICEMEASUREMENTMODE_SINGLESHOT ((VL53LX_DeviceMeasurementModes)0x10)
#define VL53LX_DEVICEMEASUREMENTMODE_BACKTOBACK ((VL53LX_DeviceMeasurementModes)0x20)
#define VL53LX_DEVICEMEASUREMENTMODE_TIMED ((VL53LX_DeviceMeasurementModes)0x40)
#define VL53LX_DEVICEMEASUREMENTMODE_ABORT ((VL53LX_DeviceMeasurementModes)0x80)

typedef uint8_t VL53LX_OffsetCalibrationMode;

#define VL53LX_OFFSETCALIBRATIONMODE__NONE ((VL53LX_OffsetCalibrationMode)0)
#define VL53LX_OFFSETCALIBRATIONMODE__MM1_MM2__STANDARD ((VL53LX_OffsetCalibrationMode)1)
#define VL53LX_OFFSETCALIBRATIONMODE__MM1_MM2__HISTOGRAM ((VL53LX_OffsetCalibrationMode)2)
...
#define VL53LX_OFFSETCORRECTIONMODE__NONE ((VL53LX_OffsetCorrectionMode)0)
#define VL53LX_OFFSETCORRECTIONMODE__MM1_MM2_OFFSETS ((VL53LX_OffsetCorrectionMode)1)
#define VL53LX_OFFSETCORRECTIONMODE__PER_VCSEL_OFFSETS ((VL53LX_OffsetCorrectionMode)3)

typedef uint8_t VL53LX_DeviceDmaxMode;

#define VL53LX_DEVICEDMAXMODE__NONE ((VL53LX_DeviceDmaxMode)0)
#define VL53LX_DEVICEDMAXMODE__FMT_CAL_DATA ((VL53LX_DeviceDmaxMode)1)
#define VL53LX_DEVICEDMAXMODE__CUST_CAL_DATA ((VL53LX_DeviceDmaxMode)2)

typedef uint8_t VL53LX_DeviceSequenceConfig;

#define VL53LX_DEVICESEQUENCECONFIG_VHV ((VL53LX_DeviceSequenceConfig)0)
#define VL53LX_DEVICESEQUENCECONFIG_PHASECAL ((VL53LX_DeviceSequenceConfig)1)
#define VL53LX_DEVICESEQUENCECONFIG_REFERENCE_PHASE ((VL53LX_DeviceSequenceConfig)2)
#define VL53LX_DEVICESEQUENCECONFIG_DSS1 ((VL53LX_DeviceSequenceConfig)3)
#define VL53LX_DEVICESEQUENCECONFIG_DSS2 ((VL53LX_DeviceSequenceConfig)4)
#define VL53LX_DEVICESEQUENCECONFIG_MM1 ((VL53LX_DeviceSequenceConfig)5)
#define VL53LX_DEVICESEQUENCECONFIG_MM2 ((VL53LX_DeviceSequenceConfig)6)
#define VL53LX_DEVICESEQUENCECONFIG_RANGE ((VL53LX_DeviceSequenceConfig)7)

typedef uint8_t VL53LX_DeviceInterruptPolarity;

#define VL53LX_DEVICEINTERRUPTPOLARITY_ACTIVE_HIGH ((VL53LX_DeviceInterruptPolarity)0x00)
#define VL53LX_DEVICEINTERRUPTPOLARITY_ACTIVE_LOW ((VL53LX_DeviceInterruptPolarity)0x10)
#define VL53LX_DEVICEINTERRUPTPOLARITY_BIT_MASK ((VL53LX_DeviceInterruptPolarity)0x10)
#define VL53LX_DEVICEINTERRUPTPOLARITY_CLEAR_MASK ((VL53LX_DeviceInterruptPolarity)0xEF)

typedef uint8_t VL53LX_DeviceGpioMode;

#define VL53LX_DEVICEGPIOMODE_OUTPUT_CONSTANT_ZERO ((VL53LX_DeviceGpioMode)0x00)
#define VL53LX_DEVICEGPIOMODE_OUTPUT_RANGE_AND_ERROR_INTERRUPTS ((VL53LX_DeviceGpioMode)0x01)
#define VL53LX_DEVICEGPIOMODE_OUTPUT_TIMIER_INTERRUPTS ((VL53LX_DeviceGpioMode)0x02)
#define VL53LX_DEVICEGPIOMODE_OUTPUT_RANGE_MODE_INTERRUPT_STATUS ((VL53LX_DeviceGpioMode)0x03)
#define VL53LX_DEVICEGPIOMODE_OUTPUT_SLOW_OSCILLATOR_CLOCK ((VL53LX_DeviceGpioMode)0x04)
#define VL53LX_DEVICEGPIOMODE_BIT_MASK ((VL53LX_DeviceGpioMode)0x0F)
#define VL53LX_DEVICEGPIOMODE_CLEAR_MASK ((VL53LX_DeviceGpioMode)0xF0)

typedef uint8_t VL53LX_DeviceError;

#define VL53LX_DEVICEERROR_NOUPDATE ((VL53LX_DeviceError)0)

#define VL53LX_DEVICEERROR_VCSELCONTINUITYTESTFAILURE ((VL53LX_DeviceError)1)
#define VL53LX_DEVICEERROR_VCSELWATCHDOGTESTFAILURE ((VL53LX_DeviceError)2)
#define VL53LX_DEVICEERROR_NOVHVVALUEFOUND ((VL53LX_DeviceError)3)
#define VL53LX_DEVICEERROR_MSRCNOTARGET ((VL53LX_DeviceError)4)
#define VL53LX_DEVICEERROR_RANGEPHASECHECK ((VL53LX_DeviceError)5)
#define VL53LX_DEVICEERROR_SIGMATHRESHOLDCHECK ((VL53LX_DeviceError)6)
#define VL53LX_DEVICEERROR_PHASECONSISTENCY ((VL53LX_DeviceError)7)
#define VL53LX_DEVICEERROR_MINCLIP ((VL53LX_DeviceError)8)
#define VL53LX_DEVICEERROR_RANGECOMPLETE ((VL53LX_DeviceError)9)
#define VL53LX_DEVICEERROR_ALGOUNDERFLOW ((VL53LX_DeviceError)10)
#define VL53LX_DEVICEERROR_ALGOOVERFLOW ((VL53LX_DeviceError)11)
#define VL53LX_DEVICEERROR_RANGEIGNORETHRESHOLD ((VL53LX_DeviceError)12)
#define VL53LX_DEVICEERROR_USERROICLIP ((VL53LX_DeviceError)13)
#define VL53LX_DEVICEERROR_REFSPADCHARNOTENOUGHDPADS ((VL53LX_DeviceError)14)
#define VL53LX_DEVICEERROR_REFSPADCHARMORETHANTARGET ((VL53LX_DeviceError)15)
#define VL53LX_DEVICEERROR_REFSPADCHARLESSTHANTARGET ((VL53LX_DeviceError)16)
#define VL53LX_DEVICEERROR_MULTCLIPFAIL ((VL53LX_DeviceError)17)
#define VL53LX_DEVICEERROR_GPHSTREAMCOUNT0READY ((VL53LX_DeviceError)18)
#define VL53LX_DEVICEERROR_RANGECOMPLETE_NO_WRAP_CHECK ((VL53LX_DeviceError)19)
#define VL53LX_DEVICEERROR_EVENTCONSISTENCY ((VL53LX_DeviceError)20)
#define VL53LX_DEVICEERROR_MINSIGNALEVENTCHECK ((VL53LX_DeviceError)21)
#define VL53LX_DEVICEERROR_RANGECOMPLETE_MERGED_PULSE ((VL53LX_DeviceError)22)

#define VL53LX_DEVICEERROR_PREV_RANGE_NO_TARGETS ((VL53LX_DeviceError)23)

typedef uint8_t VL53LX_DeviceReportStatus;

#define VL53LX_DEVICEREPORTSTATUS_NOUPDATE ((VL53LX_DeviceReportStatus)0)

#define VL53LX_DEVICEREPORTSTATUS_ROI_SETUP ((VL53LX_DeviceReportStatus)1)
#define VL53LX_DEVICEREPORTSTATUS_VHV ((VL53LX_DeviceReportStatus)2)
#define VL53LX_DEVICEREPORTSTATUS_PHASECAL ((VL53LX_DeviceReportStatus)3)
#define VL53LX_DEVICEREPORTSTATUS_REFERENCE_PHASE ((VL53LX_DeviceReportStatus)4)
#define VL53LX_DEVICEREPORTSTATUS_DSS1 ((VL53LX_DeviceReportStatus)5)
#define VL53LX_DEVICEREPORTSTATUS_DSS2 ((VL53LX_DeviceReportStatus)6)
#define VL53LX_DEVICEREPORTSTATUS_MM1 ((VL53LX_DeviceReportStatus)7)
#define VL53LX_DEVICEREPORTSTATUS_MM2 ((VL53LX_DeviceReportStatus)8)
#define VL53LX_DEVICEREPORTSTATUS_RANGE ((VL53LX_DeviceReportStatus)9)
#define VL53LX_DEVICEREPORTSTATUS_HISTOGRAM ((VL53LX_DeviceReportStatus)10)

typedef uint8_t VL53LX_DeviceDssMode;

#define VL53LX_DEVICEDSSMODE__DISABLED ((VL53LX_DeviceDssMode)0)
#define VL53LX_DEVICEDSSMODE__TARGET_RATE ((VL53LX_DeviceDssMode)1)
#define VL53LX_DEVICEDSSMODE__REQUESTED_EFFFECTIVE_SPADS ((VL53LX_DeviceDssMode)2)
#define VL53LX_DEVICEDSSMODE__BLOCK_SELECT ((VL53LX_DeviceDssMode)3)

typedef uint8_t VL53LX_HistAlgoSelect;

#define VL53LX_HIST_ALGO_SELECT__PW_HIST_GEN1 ((VL53LX_HistAlgoSelect)1)
#define VL53LX_HIST_ALGO_SELECT__PW_HIST_GEN2 ((VL53LX_HistAlgoSelect)2)
#define VL53LX_HIST_ALGO_SELECT__PW_HIST_GEN3 ((VL53LX_HistAlgoSelect)3)
#define VL53LX_HIST_ALGO_SELECT__PW_HIST_GEN4 ((VL53LX_HistAlgoSelect)4)

typedef uint8_t VL53LX_HistTargetOrder;

#define VL53LX_HIST_TARGET_ORDER__INCREASING_DISTANCE ((VL53LX_HistTargetOrder)1)
#define VL53LX_HIST_TARGET_ORDER__STRONGEST_FIRST ((VL53LX_HistTargetOrder)2)

typedef uint8_t VL53LX_HistAmbEstMethod;

#define VL53LX_HIST_AMB_EST_METHOD__AMBIENT_BINS ((VL53LX_HistAmbEstMethod)1)
#define VL53LX_HIST_AMB_EST_METHOD__THRESHOLDED_BINS ((VL53LX_HistAmbEstMethod)2)

typedef uint8_t VL53LX_HistXtalkCompEnable;

#define VL53LX_HIST_XTALK_COMP__DIS ((VL53LX_HistXtalkCompEnable)0)
#define VL53LX_HIST_XTALK_COMP__EN ((VL53LX_HistXtalkCompEnable)1)

typedef uint8_t VL53LX_DeviceConfigLevel;

#define VL53LX_DEVICECONFIGLEVEL_SYSTEM_CONTROL ((VL53LX_DeviceConfigLevel)0)

#define VL53LX_DEVICECONFIGLEVEL_DYNAMIC_ONWARDS ((VL53LX_DeviceConfigLevel)1)

#define VL53LX_DEVICECONFIGLEVEL_TIMING_ONWARDS ((VL53LX_DeviceConfigLevel)2)

#define VL53LX_DEVICECONFIGLEVEL_GENERAL_ONWARDS ((VL53LX_DeviceConfigLevel)3)

#define VL53LX_DEVICECONFIGLEVEL_STATIC_ONWARDS ((VL53LX_DeviceConfigLevel)4)

#define VL53LX_DEVICECONFIGLEVEL_CUSTOMER_ONWARDS ((VL53LX_DeviceConfigLevel)5)

#define VL53LX_DEVICECONFIGLEVEL_FULL ((VL53LX_DeviceConfigLevel)6)

typedef uint8_t VL53LX_DeviceResultsLevel;

#define VL53LX_DEVICERESULTSLEVEL_SYSTEM_RESULTS ((VL53LX_DeviceResultsLevel)0)

#define VL53LX_DEVICERESULTSLEVEL_UPTO_CORE ((VL53LX_DeviceResultsLevel)1)

#define VL53LX_DEVICERESULTSLEVEL_FULL ((VL53LX_DeviceResultsLevel)2)

typedef uint8_t VL53LX_DeviceTestMode;

#define VL53LX_DEVICETESTMODE_NONE ((VL53LX_DeviceTestMode)0x00)

#define VL53LX_DEVICETESTMODE_NVM_ZERO ((VL53LX_DeviceTestMode)0x01)

#define VL53LX_DEVICETESTMODE_NVM_COPY ((VL53LX_DeviceTestMode)0x02)

#define VL53LX_DEVICETESTMODE_PATCH ((VL53LX_DeviceTestMode)0x03)

#define VL53LX_DEVICETESTMODE_DCR ((VL53LX_DeviceTestMode)0x04)

#define VL53LX_DEVICETESTMODE_LCR_VCSEL_OFF ((VL53LX_DeviceTestMode)0x05)

#define VL53LX_DEVICETESTMODE_LCR_VCSEL_ON ((VL53LX_DeviceTestMode)0x06)

#define VL53LX_DEVICETESTMODE_SPOT_CENTRE_LOCATE ((VL53LX_DeviceTestMode)0x07)

#define VL53LX_DEVICETESTMODE_REF_SPAD_CHAR_WITH_PRE_VHV ((VL53LX_DeviceTestMode)0x08)

#define VL53LX_DEVICETESTMODE_REF_SPAD_CHAR_ONLY ((VL53LX_DeviceTestMode)0x09)
...
#define VL53LX_MACRO_PERIOD_VCSEL_PERIODS                                                     \
    (VL53LX_AMBIENT_WINDOW_VCSEL_PERIODS + VL53LX_RANGING_WINDOW_VCSEL_PERIODS)
...
#define VL53LX_ZONECONFIG_BINCONFIG__LOWAMB ((VL53LX_ZoneConfig_BinConfig_select)1)
#define VL53LX_ZONECONFIG_BINCONFIG__MIDAMB ((VL53LX_ZoneConfig_BinConfig_select)2)
#define VL53LX_ZONECONFIG_BINCONFIG__HIGHAMB ((VL53LX_ZoneConfig_BinConfig_select)3)

typedef uint8_t VL53LX_GPIO_Interrupt_Mode;

#define VL53LX_GPIOINTMODE_LEVEL_LOW ((VL53LX_GPIO_Interrupt_Mode)0)

#define VL53LX_GPIOINTMODE_LEVEL_HIGH ((VL53LX_GPIO_Interrupt_Mode)1)

#define VL53LX_GPIOINTMODE_OUT_OF_WINDOW ((VL53LX_GPIO_Interrupt_Mode)2)

#define VL53LX_GPIOINTMODE_IN_WINDOW ((VL53LX_GPIO_Interrupt_Mode)3)
