...
extern "C"
{
    ...
    VL53LX_Error VL53LX_GetMeasurementDataReady(
        VL53LX_DEV Dev, uint8_t* pMeasurementDataReady);
     ...
     * @return  "Other error code"       See ::VL53LX_Error
     */
    VL53LX_Error VL53LX_GetAdditionalData(
        VL53LX_DEV Dev, VL53LX_AdditionalData_t* pAdditionalData);
    ...
    VL53LX_Error VL53LX_SmudgeCorrectionEnable(
        VL53LX_DEV Dev, VL53LX_SmudgeCorrectionModes Mode);
    ...
    VL53LX_Error VL53LX_SetXTalkCompensationEnable(
        VL53LX_DEV Dev, uint8_t XTalkCompensationEnable);
